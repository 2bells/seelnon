...
> **Type shorthand:** `[int]`, `[float]`, `[string]`, `[bool]`, `[entity]`, `[vector3]`, `[enum]`, `[config_id]`, `[guid]`, `[generic]`, `[int[]]`, `[entity[]]`, `[string[]]`, `[float[]]`, `[dict]`, `[prefab_id]`, `[local_var]`, `[faction]`, `[config_id[]]`.
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Local Variable | `[local_var]` | Container for data storage |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Loop Start Value | `[int]` | Loop includes this value |
| Input Parameter | Loop End Value | `[int]` | Loop includes this value |
| Output Parameter | Current Loop Value | `[int]` | Integer value of the current execution logic |
...
| Input Parameter | Insert ID | `[int]` | ID of the inserted value (after insertion) |
...
| Input Parameter | ID | `[int]` | ID of edited value |
...
| Input Parameter | Remove ID | `[int]` | ID to remove |
...
| Input Parameter | Sort By | `[enum]` | Ascending or Descending |
...
| Input Parameter | Trigger Event | `[bool]` | Default: True. If set to False, this Node Graph Variable editing will not trigger the Variable Change Event |
...
| Input Parameter | Variable Value | `[generic]` | Value assigned to this variable |
| Input Parameter | Trigger Event | `[bool]` | Default: True. When set to False, this custom variable editing will not trigger the On Custom Variable Change event |
...
| Input Parameter | Preset Status Index | `[int]` | The unique identifier for the Preset Status |
| Input Parameter | Preset Status Value | `[int]` | Generally `0` for off, `1` for on |
...
| Input Parameter | Unit Tag Index List | `[int[]]` | Determines the Unit Tags carried when this entity is created |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Prefab ID | `[prefab_id]` | Identifier for this Prefab |
| Input Parameter | Location | `[vector3]` | Absolute Location |
| Input Parameter | Rotate | `[vector3]` | Absolute Rotation |
| Input Parameter | Owner Entity | `[entity]` | Determines whether the created entity belongs to another entity |
| Input Parameter | Overwrite Level | `[bool]` | When set to False, the `Level` parameter has no effect |
| Input Parameter | Level | `[int]` | Determines the Level when the entity is created |
| Input Parameter | Unit Tag Index List | `[int[]]` | Determines the Unit Tags carried when this entity is created |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Prefab Group ID | `[int]` | Identifier for this Prefab Group |
| Input Parameter | Location | `[vector3]` | Absolute Location of the Prefab Group center |
| Input Parameter | Rotate | `[vector3]` | Absolute Rotation of the Prefab Group center |
| Input Parameter | Owner Entity | `[entity]` | Determines whether the entity belongs to another entity after creation |
| Input Parameter | Level | `[int]` | Determines the Level when the entity is created |
| Input Parameter | Unit Tag Index List | `[int[]]` | Determines the Unit Tags carried when the entity is created |
| Input Parameter | Overwrite Level | `[bool]` | When set to False, the `Level` parameter has no effect |
| Output Parameter | Created Entity List | `[entity[]]` | Entities created in this way do not have a GUID |
...
| Input Parameter | Activate | `[bool]` | Set to True to make the model visible |
...
| Input Parameter | Overwrite Color Configurations | `[bool]` |  |
| Input Parameter | Enable Custom Color? | `[bool]` |  |
| Input Parameter | Fill Color | `[int]` |  |
| Input Parameter | Color Opacity | `[float]` |  |
| Input Parameter | Color Blend Type | `[enum]` |  |
| Input Parameter | Overwrite Material Configurations | `[bool]` |  |
| Input Parameter | Enable Custom Material? | `[bool]` |  |
| Input Parameter | Fill Material Type | `[int]` |  |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Environment Time | `[float]` | Must be a floating point value between 0–24; this Node will not take effect if the value is outside this range |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Environment Time Passage Speed | `[float]` | Clamped to the range 0–60. Values outside this range are automatically set to 0 or 60 |

---

## VII. Faction Related

### 1. Set Entity Faction
...
| Input Parameter | Target Location | `[vector3]` | Absolute Location |
| Input Parameter | Target Rotation | `[vector3]` | Absolute Rotation |
...
| Input Parameter | Deduct Revives | `[bool]` | If set to False, the Revive Count will not be deducted |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` | Active Player |
| Input Parameter | Revive Point ID | `[int]` | Identifier for this Revive Point |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` | Active Player |
| Input Parameter | Duration | `[int]` | Unit in seconds |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` | Active Player |
| Input Parameter | Remaining Times | `[int]` | When set to 0, the player will not be revived |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Environment Config Index | `[int]` | Identifier for this Environment Configuration |
| Input Parameter | Target Player List | `[entity[]]` | Applies only to Players in the specified list |
| Input Parameter | Enable Weather Config | `[bool]` | Set to True to enable |
| Input Parameter | Weather Config Index | `[int]` | The Weather Configuration matching this ID will take effect. If the ID does not exist, nothing happens |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` | Active Player |
| Input Parameter | Allow | `[bool]` | If set to True, reviving is allowed |
...
| Input Parameter | Elemental Energy | `[float]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Character Entity | `[entity]` |  |
| Input Parameter | Elemental Energy Increase Value | `[float]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` | Active Player |
| Input Parameter | Target Location | `[vector3]` | Absolute position |
| Input Parameter | Target Rotation | `[vector3]` | Absolute rotation |
...
| Input Parameter | Extra Collision ID | `[int]` | Identifier for this Extra Collision |
| Input Parameter | Activate | `[bool]` | Set to True to activate |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Entity |
| Input Parameter | Trigger ID | `[int]` | Identifier for this Collision Trigger |
| Input Parameter | Activate | `[bool]` | Set to True to activate |
...
| Input Parameter | Damage Coefficient | `[float]` | The coefficient applied to the damage dealt by this attack |
| Input Parameter | Damage Increment | `[float]` | The incremental damage applied by this attack |
| Input Parameter | Location Offset | `[vector3]` | When using Hitbox Attack, determines the Hitbox offset. When using Direct Attack, determines the hit-detection location for the attack and thus where on-hit special effects are created |
| Input Parameter | Rotation Offset | `[vector3]` | When using Hitbox Attack, determines the Hitbox rotation. When using Direct Attack, determines the hit-detection location for the attack and thus the rotation used for on-hit effects |
...
| Input Parameter | Overwrite Ability Unit Config | `[bool]` | When set to True, the four parameters — Damage Coefficient, Damage Increment, Location Offset, and Rotation Offset — overwrite parameters of the same name in the Ability Unit. When set to False, the Ability Unit's original configuration is used |
...
| Input Parameter | Recovery Amount | `[float]` | The amount of HP restored in this healing instance |
| Input Parameter | Ability Unit | `[string]` | Referenced Ability Unit. Must be configured on the entity associated with this Node Graph |
| Input Parameter | Overwrite Ability Unit Config | `[bool]` | When set to True, the Recovery Amount overwrites the parameter of the same name in the Ability Unit. When set to False, the Ability Unit's original configuration is used |
...
| Input Parameter | HP Loss | `[float]` | The amount of HP lost in this instance |
| Input Parameter | Lethal | `[bool]` | If set to False, this HP loss will leave the Target with at least 1 HP remaining |
| Input Parameter | Can be blocked by invincibility | `[bool]` | If set to True, and the Target is set to Invincible via Unit Status, HP loss has no effect |
| Input Parameter | Can be Blocked by Locked HP? | `[bool]` | If set to True, and the Target's HP is locked via Unit Status, HP loss has no effect |
| Input Parameter | Damage Pop-Up Type | `[enum]` | No Pop-Up / Normal Pop-Up / CRIT Hit Pop-Up |
...
| Input Parameter | Recovery Amount | `[float]` | The amount of HP restored in this healing instance |
| Input Parameter | Ignore Recovery Amount Adjustment | `[bool]` | If set to True, this healing amount is not affected by the Target's Unit Status effects that adjust healing |
| Input Parameter | Aggro Generation Multiplier | `[float]` | The Aggro generated by this healing, expressed as a multiplier. Only applicable when using Custom Aggro Mode |
| Input Parameter | Aggro Generation Increment | `[float]` | The Aggro generated by this healing, expressed as an incremental value. Only applicable when using Custom Aggro Mode |
| Input Parameter | Healing Tag List | `[string[]]` | The list of tags associated with this healing action. These can be accessed in the When HP Is Recovered and When Initiating HP Recovery events to identify a specific healing action |
...
| Input Parameter | Target Entity | `[entity]` | Active Entity |
| Input Parameter | Motion Device Name | `[string]` | Identifier for this motion device |
| Input Parameter | Movement Mode | `[enum]` |  |
| Input Parameter | Movement SPD | `[float]` |  |
| Input Parameter | Target Location | `[vector3]` | Absolute Location |
| Input Parameter | Target Rotation | `[vector3]` | Absolute Rotation |
| Input Parameter | Lock Rotation | `[bool]` |  |
| Input Parameter | Parameter Type | `[enum]` | Options: Fixed Speed or Fixed Time |
| Input Parameter | Movement Time | `[float]` |  |
...
| Input Parameter | Target Entity | `[entity]` | Active Entity |
| Input Parameter | Motion Device Name | `[string]` | Identifier for this motion device |
| Input Parameter | Motion Device Duration | `[float]` | The duration for which this motion device remains active |
| Input Parameter | Target Angle | `[vector3]` | Absolute Angle |
...
| Input Parameter | Motion Device Name | `[string]` | Identifier for this motion device |
| Input Parameter | Motion Device Duration | `[float]` | The duration for which this motion device remains active |
| Input Parameter | Velocity Vector | `[vector3]` | Determines the magnitude and direction of the velocity |
...
| Input Parameter | Motion Device Name | `[string]` | Identifier for this motion device |
| Input Parameter | Motion Device Duration | `[float]` | The duration for which this motion device remains active |
| Input Parameter | Angular Velocity (°/s) | `[float]` | Angular Velocity Magnitude |
| Input Parameter | Rotation Axis Orientation | `[vector3]` | Relative Orientation |
...
| Input Parameter | Target Entity | `[entity]` | Active Entity |
| Input Parameter | Motion Device Name | `[string]` | Identifier for this motion device |
| Input Parameter | Stop All Basic Motion Devices | `[bool]` | If set to True, stops all Basic Motion Devices on this Entity. If set to False, stops only the Motion Device whose name matches the specified Motion Device |
...
| Input Parameter | Location Offset | `[vector3]` | Location Offset based on the Follow Coordinate System |
| Input Parameter | Rotation Offset | `[vector3]` | Rotation Offset based on the Follow Coordinate System |
| Input Parameter | Follow Coordinate System | `[enum]` | Options: Relative Coordinate System or World Coordinate System |
| Input Parameter | Follow Type | `[enum]` | Options: Completely Follow, Follow Location, Follow Rotation |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Prefab ID | `[prefab_id]` | Identifier for this Projectile Prefab |
| Input Parameter | Location | `[vector3]` | Absolute Location |
| Input Parameter | Rotate | `[vector3]` | Absolute Rotation |
| Input Parameter | Owner Entity | `[entity]` | Determines whether the created entity belongs to another entity |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Special Effects Asset | `[config_id]` | Identifier for this Effect |
...
| Input Parameter | Move With the Target | `[bool]` | If set to True, follows the Target Entity's Motion |
| Input Parameter | Rotate With the Target | `[bool]` | If set to True, follows the Target Entity's Rotation |
| Input Parameter | Location Offset | `[vector3]` | Location Offset relative to the Target Entity's specified Attachment Point |
| Input Parameter | Rotation Offset | `[vector3]` | Rotation offset relative to the Target Entity's specified Attachment Point |
| Input Parameter | Zoom Multiplier | `[float]` | The Zoom Multiplier of this Effect |
| Input Parameter | Play Built-In Sound Effect | `[bool]` | If set to True, plays the built-in Sound Effect as well |
...
| Input Parameter | Rotation Offset | `[vector3]` | Rotation offset relative to the Target Entity's specified Attachment Point |
| Input Parameter | Zoom Multiplier | `[float]` | The Zoom Multiplier of this Effect |
| Input Parameter | Play Built-In Sound Effect | `[bool]` | Toggle to Yes to play built-in sound effects |
| Output Parameter | Special Effect Instance ID | `[int]` | The Instance ID automatically generated when mounting this Effect |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Special Effect Instance ID | `[int]` | Instance ID automatically generated by the Mount Looping Special Effect node |
| Input Parameter | Target Entity | `[entity]` | Active Entity |
...
| Input Parameter | Target Entity | `[entity]` | Active Entity |
| Input Parameter | Timer Name | `[string]` | Timer Identifier |
| Input Parameter | Loop | `[bool]` | If set to True, the Timer Sequence executes in a loop |
| Input Parameter | Timer Sequence | `[float[]]` | Provide a list sorted in ascending order. If the list is invalid (not strictly ascending, contains negatives, etc.), the Timer will not run |
...
| Input Parameter | Target Entity | `[entity]` | Active Entity |
| Input Parameter | Timer Name | `[string]` | Identifier for the Timer. Only Timer Names configured in Timer Management can be referenced |
| Input Parameter | Increase Value | `[float]` | For a Countdown Timer, a positive value increases the remaining time; a negative value decreases the remaining time. If the timer is set to Stopwatch, a positive value increases the accumulated time, while a negative value decreases it |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Target Player List | `[entity[]]` | Active Player List |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Entity |
| Input Parameter | Device ID | `[int]` | Identifier for the Character Disruptor Device |
...
| Input Parameter | Unit Status Config ID | `[config_id]` | Identifier for this Unit Status |
| Input Parameter | Applied Stacks | `[int]` | The Stack Count for this Unit Status |
| Input Parameter | Unit Status Parameter Dictionary | `[dict]` | You can carry a set of parameters to override the configuration values in the unit's state |
| Output Parameter | Application Result | `[enum]` | Failed, other exceptions. Failed: Yielded to another status. A yielding relationship exists between the Target's current Unit Status and the one being applied. Failed: Maximum coexistence limit reached. The specified Unit Status on the Target Entity has reached its Coexistence Limit. Failed: Unable to add additional stack. Stack addition failed. Success: New status applied. Successfully applied new Unit Status. Success: Slot stacking. Target already has this Unit Status, stacking applied |
| Output Parameter | Slot ID | `[int]` | If application succeeds, returns the Unit Status Slot ID containing the instance |
...
| Input Parameter | Unit Status Config ID | `[config_id]` | Identifier for this Unit Status |
| Input Parameter | Removal Method | `[enum]` | All Coexisting Statuses with the Same Name: Removes all statuses applied with this Config ID that share the same name. Status With Fastest Stack Loss: Removes one stack from the status that loses stacks the fastest |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Entity |
| Input Parameter | Tab ID | `[int]` | Identifier for the Tab |
| Input Parameter | Activate | `[bool]` | If set to True, it is active and can be selected |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Entity |
| Input Parameter | Activate | `[bool]` | If set to True, activates collision with Entities that carry Collision Trigger Components |
...
| Input Parameter | Level | `[int]` | Edited Level |
...
| --- | --- | --- | --- |
| Input Parameter | Target Player | `[entity]` | Active Player Entity |
| Input Parameter | Class Config ID | `[config_id]` | Class Identifier |
| Input Parameter | Existing Skill Handling | `[enum]` | Clear All: Clear all existing skills. Preserve Unrelated Skills: Retain skills that are not defined in the default skill sets of either the previous or the new class |
...
| --- | --- | --- | --- |
| Input Parameter | Target Player | `[entity]` | Active Player Entity |
| Input Parameter | EXP | `[int]` | Amount of EXP to be increased |
...
| --- | --- | --- | --- |
| Input Parameter | Target Player | `[entity]` | Active Player Entity |
| Input Parameter | UI Control Group Index | `[int]` | Identifier for the UI Control Group |
...
| --- | --- | --- | --- |
| Input Parameter | Target Player | `[entity]` | Active Player Entity |
| Input Parameter | Layout Index | `[int]` | Identifier for the UI Layout |
...
| --- | --- | --- | --- |
| Input Parameter | Target Player | `[entity]` | Active Player Entity |
| Input Parameter | UI Control Group Index | `[int]` | Identifier for the UI Control |
| Input Parameter | Display Status | `[enum]` | Off: Invisible and logic not running. On: Visible and logic running normally. Hidden: Invisible and logic running normally |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` | Active Player Entity |
| Input Parameter | Special Effect Control Index | `[int]` | Identifier for the UI Control/Fullscreen UI Control to Play the Animation on |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` |  |
| Input Parameter | Notification Queue Index | `[int]` |  |
| Input Parameter | Notification Item ID | `[int]` |  |
| Input Parameter | Notification Queue Data | `[generic]` |  |
...
| Input Parameter | Character Skill Slot | `[enum]` | The Skill Slot to edited: Normal Attack, Skill 1-E, Skill 2-Q, Skill 3-R, Skill 4-T, or Custom Skill |
| Input Parameter | Ratio Value | `[float]` | The revised actual cooldown time is: original cooldown time * ratio value |
| Input Parameter | Limit Maximum CD Time | `[bool]` | If set to True, the edited Cooldown cannot be less than the specified minimum value |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Character Entity |
| Input Parameter | Character Skill Slot | `[enum]` | The Skill Slot to initialize: Normal Attack, Skill 1-E, Skill 2-Q, Skill 3-R, Skill 4-T, or Custom Skill |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Character Entity |
| Input Parameter | Skill Resource Config ID | `[config_id]` | Skill Resource Identifier |
| Input Parameter | Target Value | `[float]` | Edited value will be set to this input value |
...
| Input Parameter | Target Entity | `[entity]` | Active Character Entity |
| Input Parameter | Character Skill Slot | `[enum]` | The Skill Slot to edited: Normal Attack, Skill 1-E, Skill 2-Q, Skill 3-R, Skill 4-T, or Custom Skill |
| Input Parameter | CD Time | `[float]` | Edited Cooldown will be set to this input value |
| Input Parameter | Limit Maximum CD Time | `[bool]` | If set to True, the edited Cooldown cannot be less than the specified minimum value |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Character Entity |
| Input Parameter | Skill Config ID | `[config_id]` | Skill Identifier |
| Input Parameter | Skill Slot | `[enum]` | The Skill Slot to be added: Normal Attack, Skill 1-E, Skill 2-Q, Skill 3-R, Skill 4-T, or Custom Skill |
| Input Parameter | Original Slot Skill Handling | `[enum]` | Destroy: Remove the original skill. Preserve Slot Binding: Retain the current slot binding. When the newly bound skill instance is removed, it is automatically displayed in that slot. Remove Slot Binding: The skill must be reassigned to the specified slot in order to be displayed in that slot |
| Output Parameter | Switched Skill Instance ID | `[int]` |  |
...
| Input Parameter | Target Entity | `[entity]` | Active Character Entity |
| Input Parameter | Skill Resource Config ID | `[config_id]` | Skill Resource Identifier |
| Input Parameter | Increase Value | `[float]` | The modified value is: original value + increase value |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Character Entity |
| Input Parameter | Character Skill Slot | `[enum]` | The Skill Slot to be edited: Normal Attack, Skill 1-E, Skill 2-Q, Skill 3-R, Skill 4-T, or Custom Skill |
| Input Parameter | CD Time Increase Value | `[float]` | The modified value is: original value + increase value |
| Input Parameter | Limit Maximum CD Time | `[bool]` | If set to True, the edited Cooldown cannot be less than the specified minimum value |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Character Entity |
| Input Parameter | Character Skill Slot | `[enum]` | The Skill Slot to be deleted: Normal Attack, Skill 1-E, Skill 2-Q, Skill 3-R, Skill 4-T, or Custom Skill |
...
### 10. Bind Custom Skill Instance to Specified Slot
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Character Entity |
| Input Parameter | Skill Instance ID | `[int]` | Identifier for the Skill Instance |
| Input Parameter | Skill Slot | `[enum]` |  |
| Input Parameter | Original Slot Skill Handling | `[enum]` | Destroy: Remove the original skill. Preserve Slot Binding: Retain the current slot binding. When the newly bound skill instance is removed, it is automatically displayed in that slot. Remove Slot Binding: The skill must be reassigned to the specified slot in order to be displayed in that slot |
| Output Parameter | Original Slot Skill Instance ID | `[int]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Character Entity | `[entity]` | Active Character Entity |
| Input Parameter | Specified Slot | `[enum]` |  |
| Output Parameter | Unbound Skill Instance ID List | `[int[]]` | List of skill instance IDs unbound from the slot |
...
| Input Parameter | Character Entity | `[entity]` | Active Character Entity |
| Input Parameter | Skill Config ID | `[config_id]` | Skill Identifier |
| Output Parameter | Skill Instance ID | `[int]` | Identifier for the Skill Instance |
...
| Input Parameter | Character Entity | `[entity]` | Active Character Entity |
| Input Parameter | Skill Slot | `[enum]` |  |
| Input Parameter | Check Key Availability | `[bool]` | Yes: Cast only when the key is available. No: Cast even if the key is not available |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | SFX Player ID | `[int]` |  |
| Input Parameter | Volume | `[int]` |  |
| Input Parameter | Playback Speed | `[float]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Sound Effect Asset Index | `[int]` |  |
| Input Parameter | Volume | `[int]` |  |
| Input Parameter | Playback Speed | `[float]` |  |
| Input Parameter | Loop Playback | `[bool]` |  |
| Input Parameter | Loop Interval Time | `[float]` |  |
| Input Parameter | 3D Sound Effect | `[bool]` |  |
| Input Parameter | Range Radius | `[float]` |  |
| Input Parameter | Attenuation Mode | `[enum]` |  |
| Input Parameter | Attachment Point Name | `[string]` |  |
| Input Parameter | Attachment Point Offset | `[vector3]` |  |
| Output Parameter | SFX Player ID | `[int]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Active Player Entity |
| Input Parameter | Background Music Index | `[int]` |  |
| Input Parameter | Start Time | `[float]` |  |
| Input Parameter | End Time | `[float]` |  |
| Input Parameter | Volume | `[int]` |  |
| Input Parameter | Loop Playback | `[bool]` |  |
| Input Parameter | Loop Interval | `[float]` |  |
| Input Parameter | Playback Speed | `[float]` |  |
| Input Parameter | Enable Fade In/Out | `[bool]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Unit Tag Index | `[int]` |  |
...
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Aggro Owner Entity | `[entity]` |  |
| Input Parameter | Aggro Value | `[int]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Nameplate Config ID List | `[config_id[]]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Text Bubble Configuration ID | `[config_id]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Player | `[entity]` | Active Player Entity |
| Input Parameter | Deck Selector Index | `[int]` |  |
...
| Input Parameter | Deck Selector ID | `[int]` | Referenced UI Control Group ID |
| Input Parameter | Select Duration | `[float]` | If empty, uses the Deck Selector's default configuration; otherwise, this time value is used as the effective duration. Unit in seconds. If the duration exceeds 2,000,000 seconds, it can no longer be invoked |
| Input Parameter | Select Result Corresponding List | `[int[]]` | One-to-one with display items: the Deck Selector returns the result value corresponding to each display item. Recommended configuration: 1 to X |
| Input Parameter | Select Display Corresponding List | `[int[]]` | Deck Library Configuration Reference |
| Input Parameter | Select Minimum Quantity | `[int]` | The minimum number of cards that must be selected for a valid interaction |
| Input Parameter | Select Maximum Quantity | `[int]` | The maximum number of cards that can be selected for a valid interaction |
| Input Parameter | Refresh Mode | `[enum]` | Cannot Refresh: Both input parameters (Refresh Maximum Quantity and Refresh Maximum Quantity) are ignored, and the selection screen has no refresh button. Partial Refresh: Both input parameters (Refresh Maximum Quantity and Refresh Maximum Quantity) take effect, and the selection screen includes a refresh button. Refresh All: Both input parameters (Refresh Maximum Quantity and Refresh Maximum Quantity) are ignored. All results are returned by default, and the selection screen includes a refresh button |
| Input Parameter | Refresh Minimum Quantity | `[int]` | The minimum number of cards that must be selected for a valid refresh interaction |
| Input Parameter | Refresh Maximum Quantity | `[int]` | The maximum number of cards that can be selected for a valid refresh interaction |
| Input Parameter | Default Return Selection | `[int[]]` | If the Deck Selector times out, has no interaction, or closes abnormally, force-assign this configured result. The length of this Result List must match the valid card selection count |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Select List | `[int[]]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` |  |
| Input Parameter | Settlement Status | `[enum]` | Three types: Undefined, Victory, Defeat |
...
| Input Parameter | Data Order | `[int]` | The sort order of this data |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` |  |
| Input Parameter | Ranking Value | `[int]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Light Source ID | `[int]` |  |
| Input Parameter | Enable or Disable | `[bool]` | If set to True, turns On |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Target Structure | `[generic]` |  |
...
| Input Parameter | Shop ID | `[int]` | The Shop ID corresponding to the Shop component on the Shop Owner Entity |
| Input Parameter | Item Config ID | `[config_id]` |  |
...
| Input Parameter | Shop Owner Entity | `[entity]` |  |
| Input Parameter | Shop ID | `[int]` | The Shop ID corresponding to the Shop component on the Shop Owner Entity |
| Input Parameter | Shop Item Config ID | `[config_id]` |  |
...
| Input Parameter | Shop Owner Entity | `[entity]` |  |
| Input Parameter | Shop ID | `[int]` | The Shop ID corresponding to the Shop component on the Shop Owner Entity |
| Input Parameter | Shop Item ID | `[int]` |  |
...
| Input Parameter | Shop ID | `[int]` | The Shop ID corresponding to the Shop component on the Shop Owner Entity |
| Input Parameter | Shop Item Config ID | `[config_id]` |  |
| Input Parameter | Sell Currency Dictionary | `[dict]` |  |
| Input Parameter | Affiliated Tab ID | `[int]` | 1 Equipment, 2 Consumables, 3 Materials, 4 Valuables |
| Input Parameter | Sort Priority | `[int]` |  |
| Input Parameter | Can Be Sold | `[bool]` |  |
...
| Input Parameter | Shop ID | `[int]` | The Shop ID corresponding to the Shop component on the Shop Owner Entity |
| Input Parameter | Shop Item Config ID | `[config_id]` |  |
| Input Parameter | Purchase Currency Dictionary | `[dict]` |  |
| Input Parameter | Purchasable | `[bool]` |  |
...
| Input Parameter | Sell Currency Dictionary | `[dict]` |  |
| Input Parameter | Affiliated Tab ID | `[int]` | 1 Equipment, 2 Consumables, 3 Materials, 4 Valuables |
| Input Parameter | Limit Purchase | `[bool]` |  |
| Input Parameter | Purchase Limit | `[int]` |  |
| Input Parameter | Sort Priority | `[int]` |  |
| Input Parameter | Can Be Sold | `[bool]` |  |
| Output Parameter | Item Index | `[int]` |  |
...
| Input Parameter | Item Config ID | `[config_id]` |  |
| Input Parameter | Sell Currency Dictionary | `[dict]` |  |
| Input Parameter | Affiliated Tab ID | `[int]` |  |
| Input Parameter | Sort Priority | `[int]` |  |
| Input Parameter | Can Be Sold | `[bool]` |  |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Equipment Index | `[int]` | Integer ID generated during Equipment Initialization to identify the equipment instance |
| Input Parameter | Affix ID | `[int]` | Each ID corresponds to one single Affix |
| Input Parameter | Affix Value | `[float]` |  |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Equipment ID | `[int]` | Integer ID generated during Equipment Initialization to identify the equipment instance |
| Input Parameter | Affix ID | `[int]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Equipment ID | `[int]` | Integer ID generated during Equipment Initialization to identify the equipment instance |
| Input Parameter | Affix Config ID | `[config_id]` | The Config ID of the preconfigured Affix defined in Equipment Data Management |
| Input Parameter | Overwrite Affix Value | `[bool]` |  |
| Input Parameter | Affix Value | `[float]` | Can overwrite the value on a pre-configured Affix |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Equipment Row | `[int]` |  |
| Input Parameter | Equipment Column | `[int]` |  |
| Input Parameter | Equipment Index | `[int]` | The equipment instance is identified by an integer index generated during equipment initialization |
...
| Input Parameter | Equipment Slot Row Count | `[int]` |  |
| Input Parameter | Equipment Slot Column Count | `[int]` |  |
...
| Input Parameter | Item Drop Dictionary | `[dict]` |  |
| Input Parameter | Loot Type | `[enum]` | Types: Shared Reward (one share for all), Individualized Reward (one share per person) |
...
| --- | --- | --- | --- |
| Input Parameter | Inventory Owner Entity | `[entity]` |  |
| Input Parameter | Item/Currency Config ID | `[config_id]` |  |
| Input Parameter | Quantity Dropped | `[int]` |  |
| Input Parameter | Loot Type | `[enum]` | Types: Shared Reward (one share for all), Individualized Reward (one share per person) |
...
| --- | --- | --- | --- |
| Input Parameter | Dropper Entity | `[entity]` |  |
| Input Parameter | Loot Drop Dictionary | `[dict]` |  |
...
| Input Parameter | Inventory Owner Entity | `[entity]` |  |
| Input Parameter | Item Config ID | `[config_id]` |  |
| Input Parameter | Increase Value | `[int]` | The changed value = original value + increase value |
...
| --- | --- | --- | --- |
| Input Parameter | Inventory Owner Entity | `[entity]` |  |
| Input Parameter | Currency Config ID | `[config_id]` |  |
| Input Parameter | Increase Value | `[int]` | The changed value = original value + increase value |
...
| --- | --- | --- | --- |
| Input Parameter | Inventory Owner Entity | `[entity]` |  |
| Input Parameter | Increase Capacity | `[int]` |  |
...
| Input Parameter | Mini-Map Marker ID | `[int]` | ID of the specified Mini-map Marker to be edited |
| Input Parameter | Player List | `[entity[]]` | The specified Mini-map ID on the Target Entity, visible only to the Player providing input |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` | Entity that owns the Mini-map Marker component to be edited |
| Input Parameter | Mini-Map Marker ID List | `[int[]]` | List of Mini-map Marker IDs to be set to the specified status. Unconfigured Mini-map Markers will be set to the opposite status |
| Input Parameter | Active | `[bool]` | If input is True, the Mini-map Markers corresponding to the specified ID numbers in the input list will be set to Enabled. For IDs not in the input list, the corresponding Mini-map Markers will be set to Disabled |
...
| Input Parameter | Zoom Dimensions | `[float]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Mini-Map Marker ID | `[int]` |  |
| Input Parameter | Player List | `[entity[]]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Player | `[entity]` |  |
| Input Parameter | Map Config ID | `[config_id]` |  |
| Input Parameter | Display Map? | `[bool]` | Toggle Yes to display map |
...
| Input Parameter | Patrol Template ID | `[int]` |  |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Player ID List | `[int[]]` |  |
| Input Parameter | Leaderboard Score | `[float]` |  |
| Input Parameter | Leaderboard ID | `[int]` | The ID corresponding to the specified Leaderboard in Peripheral System management |
...
| --- | --- | --- | --- |
| Input Parameter | Player ID List | `[int[]]` |  |
| Input Parameter | Leaderboard Score | `[int]` |  |
| Input Parameter | Leaderboard ID | `[int]` | The ID corresponding to the specified Leaderboard in Peripheral System management |
...
| Input Parameter | Achievement ID | `[int]` |  |
| Input Parameter | Progress Tally Increase Value | `[int]` | New Value = Previous Value + Change Value |
...
| Input Parameter | Achievement ID | `[int]` |  |
| Input Parameter | Progress Tally | `[int]` | Sets the Progress Count to the input value |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Rule Type | `[enum]` | Options: Prioritize View or Prioritize Distance |
...
| --- | --- | --- | --- |
| Input Parameter | Target Entity | `[entity]` |  |
| Input Parameter | Scan Tag ID | `[int]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` |  |
| Input Parameter | Score Group ID | `[int]` | The ID corresponding to the specified Score Group in Peripheral System management |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` |  |
| Input Parameter | Settlement Status | `[enum]` | Includes: Undefined, Victory, Defeat, Escape |
| Input Parameter | Score Change | `[int]` |  |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Entity Deployment Group Index | `[int]` |  |
| Input Parameter | Activate | `[bool]` | If set to True, the Entity Layout Group's Initial Creation switch is enabled |
...
| Parameter Type | Parameter Name | Type | Description |
| --- | --- | --- | --- |
| Input Parameter | Channel Index | `[int]` |  |
| Input Parameter | Voice-Over Switch | `[bool]` |  |
| Input Parameter | Text Switch | `[bool]` |  |
...
| Input Parameter | Channel Index List | `[int[]]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Target Player | `[entity]` |  |
| Input Parameter | Channel List | `[int[]]` |  |
| Input Parameter | Limit Permissions | `[bool]` | When enabled, the corresponding functionality of the player in the designated channel list will be restricted |
...
| Input Parameter | Target Player | `[entity]` |  |
| Input Parameter | Channel List | `[int[]]` |  |
| Input Parameter | Effective Range | `[int]` | This determines the distance within which the target player can hear voice chat from other players in the same channel, and does not affect the range at which other players can hear the target player. Range: 1–100 m |
| Input Parameter | Limit Scope | `[bool]` | The range takes effect only when this option is enabled; When disabled, the configured range value is ignored |
...
| Input Parameter | Target Player | `[entity]` |  |
| Input Parameter | Channel List | `[int[]]` |  |
| Input Parameter | Restrict Voice Chat (Speak) | `[bool]` | When enabled, other players cannot hear the target player's voice |
| Input Parameter | Restrict Voice Chat (Listen) | `[bool]` | When enabled, the target player cannot hear other players' voices |
...
| Input Parameter | Player GUID | `[guid]` |  |
| Input Parameter | Channel Index | `[int]` |  |
| Input Parameter | Join | `[bool]` | When enabled, the channel is only available to the specified player(s) |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` |  |
| Input Parameter | Gift Box Index | `[int]` |  |
| Input Parameter | Consumption Quantity | `[int]` |  |
| Output Parameter | Consumer? | `[bool]` | Output Parameter reads Yes when Gift Box is successfully consumed |
...
| Input Parameter | Pathfinding Obstacle ID | `[int]` |  |
| Input Parameter | Activate | `[bool]` |  |
...
| Input Parameter | Preset Status Index | `[int]` |  |
| Input Parameter | Preset Status Value | `[int]` |  |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` | Active Player Entity |
| Input Parameter | Floating Interaction Page Index | `[int]` | Unique Identifier of the Floating Interaction Page |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` | Active Player Entity |
| Input Parameter | List Index | `[int]` | Unique Identifier for a Tab or Single-Choice Window |
| Input Parameter | Visible List Item | `[int[]]` | List of items for the tab or single-choice window. The input will update the visible list items of the specified tab or single-choice window |
| Input Parameter | Select First Item by Default | `[bool]` | Yes: Select the first item by default. No: Keeps the last selected item (if any) |
...
| Input Parameter | Player Entity | `[entity]` | Active Player Entity |
| Input Parameter | Floating Interaction Page Index | `[int]` | Unique Identifier of the Floating Interaction Page |
| Input Parameter | Initialize List Data | `[dict]` | Key (int): Index corresponding to the tab or single-choice window. Value (List): Integer list corresponding to the tab items (for tabs) or item list (for single-choice windows) |
...
| --- | --- | --- | --- |
| Input Parameter | Player Entity | `[entity]` |  |
| Input Parameter | Quest Index | `[int]` |  |
| Input Parameter | Task Count | `[int]` |  |
...
| Input Parameter | Player Entity | `[entity]` |  |
| Input Parameter | Quest Index | `[int]` |  |
| Input Parameter | Task Count Increased by | `[int]` | New Value = Previous Value + Increase Value |