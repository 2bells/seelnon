var Brush = (function () {
    ...
    function Brush (wgl, shaderSources, maxBristleCount) {
        ...
        this.bristleLength = 4.5;
        this.bristleJitter = 0.5;
        this.bristleScatter = 1.0;
        this.bristleStiffness = 0.3;
    ...
    Brush.prototype.initialize = function (x, y, z, scale) {
        ...
        var setBristlesDrawState = wgl.createDrawState()
            ...
            .uniform1f('u_bristleLength', this.bristleLength)
            .uniform1f('u_verticesPerBristle', VERTICES_PER_BRISTLE)
            .uniform1f('u_jitter', this.bristleJitter)
            .uniform1f('u_bristleScatter', this.bristleScatter !== undefined ? this.bristleScatter : 1.0)
        ...
        for (var i = 0; i < ITERATIONS; ++i) {
            ...
            for (var pass = 0; pass < 2; ++pass) {
                ...
                var constraintDrawState = wgl.createDrawState()
                    ...
                    .uniform1f('u_targetDistance', this.scale * this.bristleLength / (VERTICES_PER_BRISTLE - 1))
            ...
            for (var pass = 0; pass < 3; ++pass) {
                ...
                var constraintDrawState = wgl.createDrawState()
                    ...
                    .uniform1f('u_pointCount', VERTICES_PER_BRISTLE)
                    .uniform1f('u_stiffnessVariation', this.bristleStiffness)
                    .uniform1i('u_pass', pass)
                    .uniform2f('u_resolution', this.maxBristleCount, VERTICES_PER_BRISTLE)
