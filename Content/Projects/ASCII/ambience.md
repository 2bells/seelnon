# ASCII Zen Garden Ambience Reference

This file maps each scene ID to a default YouTube video ID for atmospheric sounds.

| Scene ID | Video ID | Description |
|----------|----------|-------------|
...
| sand     | https://youtu.be/2OEL4P1Rz04 | Zen Garden Meditation |
| shapes   | https://youtu.be/8_X2_X_X_X8 | Deep Heartbeat Drone |
| shapes2  | https://youtu.be/8_X2_X_X_X8 | Deep Heartbeat Drone |

*Note: These IDs are used by the application to automatically load background audio when switching scenes.*
