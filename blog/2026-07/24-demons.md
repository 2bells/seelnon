...
![img](https://i.pinimg.com/736x/44/a9/bf/44a9bf0bc02c8755d6093c15a8740017.jpg)

Watched some exorcists and priests on podcasts, as well as was going through Book of Enoch a bit for just own educational purposes.

But the main problem I have is: priests that are constantly doing AMOUNTS of logical fallacies:

- Appeal to Authority: Accepting a claim just because an expert or celebrity said so.
- False Dilemma: Presenting only two choices when more options exist.
- Slippery Slope: Claiming a small step leads to a major, unlikely chain of events.
- Circular Reasoning: Using the conclusion as a premise to prove itself.
- Hasty Generalization: Making a broad rule from too little evidence.
- etc.
...
> Everyone is a demon.. (except you and me here in this room of course, that is implied, and ESPECIALLY not me, I'm wearing the priest robe... c'mon don't be silly, demons can't wear clothes of the Holy Land and they can't call to Jesus in a prayer ever and of course they will never wear His 'blood' as a 'coat' for their soul to hide the presence... silly you! Look, I have a pointy hat and a talking stick!) And! I'm telling you! '__insert agenda__'. [usually political]
...
>_
Knowledge = Gnosis = Occult = Demonic

The true way of light is...
