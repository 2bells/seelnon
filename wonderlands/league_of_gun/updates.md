...
DESCRIPTION: Found exact placements for League towers. Schizo out -> made full replica 1 to 1. Figured out that AI pathing turns off if you are too far from the enemy -> got sad. Game is still up.
---
